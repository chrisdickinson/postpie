...
var CharField = defaultFieldCreator(),
    ...
    ForeignKey = function(rel, kwargs) {
        this.rel = rel;
        this.kwargs = kwargs;
    }; 
...
ForeignKey.prototype.jsToLocal = function(value) {
    return this.rel.to_field.jsToLocal(value);
};

ForeignKey.prototype.localToJS = function(values) {
    return new this.rel.to_field.model(values);
};
